...
class Ui_REProduct(object):
    def setupUi(self, REProduct):
        ...
        self.search_container = QtWidgets.QGroupBox(
            parent=self.contents_container_w)
        ...
        self.furniture_input = QtWidgets.QLineEdit(
            parent=self.furniture_cotnainer_w)
        ...
        self.wards_container_w = QtWidgets.QWidget(
            parent=self.search_container)
        ...
        self.options_input = QtWidgets.QComboBox(
            parent=self.options_container_w)
        self.options_input.setObjectName("options_input")
        self.options_input.addItem("")
        self.verticalLayout_14.addWidget(self.options_input)
        self.verticalLayout_13.addLayout(self.verticalLayout_14)
        self.gridLayout.addWidget(self.options_container_w, 0, 1, 1, 1)
        self.categories_container_w = QtWidgets.QWidget(
            parent=self.search_container)
        self.categories_container_w.setObjectName("categories_container_w")
        self.verticalLayout_25 = QtWidgets.QVBoxLayout(
            self.categories_container_w)
        ...
        self.categories_input = QtWidgets.QComboBox(
            parent=self.categories_container_w)
        self.categories_input.setObjectName("categories_input")
        ...
        self.building_line_s_container_w.setObjectName(
            "building_line_s_container_w")
        self.verticalLayout_21 = QtWidgets.QVBoxLayout(
            self.building_line_s_container_w)
        ...
        self.furniture_s_container_w = QtWidgets.QWidget(
            parent=self.search_container)
        self.furniture_s_container_w.setObjectName("furniture_s_container_w")
        self.verticalLayout_19 = QtWidgets.QVBoxLayout(
            self.furniture_s_container_w)
        ...
        self.legal_s_container_w = QtWidgets.QWidget(
            parent=self.search_container)
        self.legal_s_container_w.setObjectName("legal_s_container_w")
        self.verticalLayout_23 = QtWidgets.QVBoxLayout(
            self.legal_s_container_w)
        ...
        self.legal_s_input = QtWidgets.QComboBox(
            parent=self.legal_s_container_w)
        self.legal_s_input.setObjectName("legal_s_input")
        self.legal_s_input.addItem("")
        self.verticalLayout_24.addWidget(self.legal_s_input)
        ...
        self.street_container_w = QtWidgets.QWidget(
            parent=self.search_container)
        ...
        self.actions_container_w = QtWidgets.QGroupBox(
            parent=self.contents_container_w)
        ...
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(
            self.actions_container_w)
        self.horizontalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_2.setSpacing(4)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.action_create_btn = QtWidgets.QPushButton(
        ...
        self.products_table = QtWidgets.QTableView(
            parent=self.contents_container_w)
        ...
        self.detail_action_container_w.setObjectName(
            "detail_action_container_w")
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout(
            self.detail_action_container_w)
    ...
    def retranslateUi(self, REProduct):
        ...
        self.wards_input.setItemText(0, _translate("REProduct", "Tất cả"))
        self.options_label.setText(
            _translate("REProduct", "Loại hình kinh doanh")
        )
        self.options_input.setItemText(0, _translate("REProduct", "Tất cả"))
        self.categories_label.setText(
            _translate("REProduct", "Danh mục bất động sản")
        )
        self.categories_input.setItemText(0, _translate("REProduct", "Tất cả"))
        self.building_line_s_label.setText(_translate("REProduct", "Lộ giới"))
        self.building_line_s_input.setItemText(
            0, _translate("REProduct", "Tất cả")
        )
        self.furniture_s_lable.setText(_translate("REProduct", "Nội thất"))
        self.furniture_s_input.setItemText(
            0, _translate("REProduct", "Tất cả"))
        self.legal_s_label.setText(_translate("REProduct", "Pháp lý"))
        self.legal_s_input.setItemText(0, _translate("REProduct", "Tất cả"))
