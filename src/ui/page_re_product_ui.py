...
class Ui_PageREProduct(object):
    def setupUi(self, PageREProduct):
        ...
        PageREProduct.setStyleSheet("#REProduct{\n"
...
"padding-left: 4px;")
        ...
        self.action_settings_btn = QtWidgets.QPushButton(parent=self.actions_container_w)
    ...
    def retranslateUi(self, PageREProduct):
        ...
        self.categories_label.setText(_translate("PageREProduct", "Danh mục bất động sản"))
        ...
        self.building_line_s_combobox.setItemText(0, _translate("PageREProduct", "Tất cả"))
